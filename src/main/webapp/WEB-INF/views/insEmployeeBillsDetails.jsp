...
<body>
	...
	<div id="main">
		<div class="wrapper">
			...
			<form
				action="<%=request.getContextPath()%>/home/myInsurancePlan/bills/new/billDetail/new/save/${billNo}"
				method="post">
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<table id="billDetails" class="responstable dynamicTable">
									...
									<tbody>
													...
													<td><select id="categoryId${i.index}"
														name="categoryId${i.index}">
															...
															id2="${category.unitCost}">${category.categoryDesc}</option> --%>
																<option 
																	value="${category.categoryId}" id2="${category.unitCost}"
										...
										<tr>
											...
											<td><input type="number" name="unitCost${countLoop}"
												id="unitCost${countLoop}" onkeyup="changeTotal(this)"/></td>
											<td><input type="number" name="quantity${countLoop}"
												id="quantity${countLoop}" onkeyup="changeTotal(this)"/></td>

											<td><input type="number" name="totalAmt${countLoop}"
								...
								<button type="button" id="btnAddRow" class="btn blue darken-2">Add
									Row</button>
								<button type="button" id="btnRemove" class="btn red darken-1">Remove
									Last Row</button>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<input type="text" id="totalAmount" name="totalAmount" style="color: black; border-bottom-color: #9e9e9e; border-bottom-style: double;"
										value="${total}" readonly="readonly"/><label for="totalAmount" style="color: #21b6ca;">Bill
										Total(Rs.)</label>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="form-group">
										...
										<a
									href="<%= request.getContextPath()%>/home/myInsurancePlan/${planEmployeeId}/newClaim#tabBillInfo" class="btn btn yellow darken-3">Back</a>
	...
	changeTotal(e1);
		...
		function changeTotal(e) {
			...
			for ( var i = 0; i <= rowCount; i++) {
				var amount=(document.getElementById('totalAmt'+i||{}).value)||"";
				if(amount!=null&amount!=""){
				total = parseFloat(total)
						+ parseFloat($('#totalAmt' + i).val());
				}

					...
					<form:form id="preAuthForm" method="post" action="${claim.insPlanEmployeeClaimId}/approve"
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										...
										<input type="text"
											value="${claimDetails.dependent.dependentName}"
						...
						<div id="tabProviderInfo" class="col s12 tab_content">
							...
							<div class="form-group is-empty">
								...
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<form:input path="amountApproved" name="totalApproved" id="totalApproved"
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<input type="text" id="inscomments" name="inscomments"  />
										<label for="hrcomments">Insurance Committee Comments</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<a class="btn red darken-3"
									href="<%=request.getContextPath() %>/home/controlPanel/insurancePlans/searchClaims/PAFINSApprove/reject/${claim.insPlanEmployeeClaimId}">Reject</a>

			...
			<div class="white col-md-12">
				<div class="row">
					<div class="col-sm-6 col-md-9 py-1 px-1">
						<h4 class="h4-responsive">Insurance Desk Approve -Bills
				...
				<div class="row">
					<form:form id="preAuthForm" method="post" action="approve"
								...
								<div class="md-form auth_dropdown">
									<div class="col-md-6 padding_left_0">
										<form:select path="hospitalId" name="hospitalId">
											...
											<c:if test="${hospitalSelected}"><option value="0" ${preAuthBean.hospitalId eq 0 ? 'selected="selected"' : ''}>other</option></c:if>
											<c:if test="${!hospitalSelected}"><option value="0">other</option></c:if>
										</form:select>
											...
											<c:if test="${beans ne null}">
											 <c:forEach items="${beans}" var="bean" varStatus="it">
													...
													<tr>
														...
														<td>${bean.claimBill.billNo}</td>
													<td><fmt:formatDate type = "date" 
         value = "${bean.claimBill.billDate}"/></td>
													<td>${bean.claimBill.billIssuer}</td>
												
													
													<td>${bean.claimBill.amountRequested}</td>


												<td><a href="<%=request.getContextPath()%>/home/controlPanel/insurancePlans/optedEmployees/bills/new/billDetail/${bean.claimBill.claimBillId}"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
												</tr>
								...
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<form:input path="amountRequired" id="amountRequired"
											required="true" />
										<label for="amountRequired">Total Amount Requested(Bill
											Total)</label>
									</div>
								</div>
							</div>
...
<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<form:input path="amountApproved" id="amountApproved"
											required="true" />
										<label for="amountApproved">Total Amount Approved(Bill
											Total)</label>
									</div>
								</div>
							</div>
								...
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<input type="text" id="hrcomments" name="hrcomments"
											value="${claimDetails.hrComments}"  /> <label
							...
							<div class="form-group">
								...
								<a class="btn red darken-3"
									href="<%=request.getContextPath() %>/home/controlPanel/insurancePlans/searchClaims/billsHRApprove/reject/${claim.insPlanEmployeeClaimId}">Reject</a>

			...
			<div class="white col-md-12">
				<div class="row">
					<div class="col-sm-6 col-md-9 py-1 px-1">
						<h4 class="h4-responsive">Bills Management Approval -
...
<c:if test="${speclistServiceRequired eq  true}">
							<div id="specialistDetails">
								<div class="form-group is-empty">
									<div class="md-form">
										<div class="col-md-6 padding_left_0">
											<label style="color: rgba(238, 110, 115, 0.7);margin-top: -10px;">Specialist
												Details</label>
										</div>
									</div>
								</div>
											...
											<tbody>
												<c:if test="${bills ne null}">
													...
													<c:forEach items="${bills}" var="bill">
														<tr>
															<td>${bill.billNo}</td>
															<td><fmt:formatDate pattern="dd/MMM/yyyy" value = "${bill.billDate}"/></td>
															<td>${bill.billIssuer}</td>

															<td>${bill.amountRequested}</td>
															<td>${bill.amountVerified}</td>
															<td><a
																href="<%=request.getContextPath()%>/home/controlPanel/insurancePlans/searchClaims/billsGMApprove/billDetail/${bill.claimBillId}"><i
...
<div class="form-group is-empty">
						 ...
						 <div class="form-group is-empty">
								...
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<input type="number"name="totalApproved" id="totalApproved" value="${claim.totalApprovedAmount}"
											 readonly="readonly"/> <label for="totalApproved">Total
							...
							<div class="form-group is-empty">
								...
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<form:textarea path="insComments" id="insComments" /><label
											for="hrComments">Insurance Comments</label>
									</div>
								</div>
							</div>
								...
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<textarea name="gmComments" id="gmComments" ></textarea><label
											for="insComments">General Management Comments</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<a class="btn red darken-3"
									href="<%=request.getContextPath() %>/home/controlPanel/insurancePlans/searchClaims/billsGMApprove/${claim.insPlanEmployeeClaimId}/reject">Reject</a>

			...
			<div class="white col-md-12">
				<div class="row">
					<div class="col-sm-6 col-md-9 py-1 px-1" style="color: #21b6ca;">
						<h4 class="h4-responsive">PAF Details -
							${claim.claimRefno}</h4>
					</div>
				</div>
				
				<div class="row">
				<div class="col-sm-6 col-md-9 py-1 px-1" style="color: #EC0B12;">
				Status :
				<c:choose>
					<c:when test="${claim.status eq 'SUBM'}">Submitted</c:when>
					<c:when test="${claim.status eq 'APPR'}">Approved</c:when>
					<c:when test="${claim.status eq 'HR_APPR'}">Insurance Desk Approved</c:when>
					<c:when test="${claim.status eq 'INS_APPR'}">Insurance Committee Approved</c:when>
					<c:when test="${claim.status eq 'MNG_APPR'}">Management Approved</c:when>
				</c:choose>
					...
					<form:form id="preAuthForm" method="post" action="${claim.insPlanEmployeeClaimId}/approve"
						...
						<div id="tabProcedureInfo" class="col s12 tab_content">
								...
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<input type="number" name="totalApproved" id="totalApproved"
											value="${claimDetails.amountTotalApproved}" /> <label for="totalApproved">Total
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<input type="number" name="ins1" id="ins1" value="${amt1}"/> <label
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<input type="number" name="ins2" id="ins2" value="${amt2}" /> <label
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<input type="text" id="hrcomments" name="hrcomments" value="${claimDetails.hrComments}" />

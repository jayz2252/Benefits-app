	...
	<div id="main">
		<div class="wrapper">
			...
			<div class="white col-md-12">
					...
					<div class="row">
						<table>
							<tr>
								...
								<td>Claim Status <strong> <c:choose>
				...
				<div class="row">
					<form:form id="preAuthForm" method="post"
						action="${claimId}/approve" modelAttribute="preAuthBean"
						...
						<div id="tabBillInfo" class="col s12 tab_content">
									...
									<div class="col-md-12 padding_left_0">
										...
										<table class="responstable ">
											...
											value="${bill.billDate}" /></td>
															...
															<td><a
																href="<%=request.getContextPath()%>/home/controlPanel/insurancePlans/searchClaims/viewClaim/details/${bill.claimBillId}"><i
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<form:textarea path="hrComments" id="hrComments" />
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<form:textarea path="insComments" id="insComments" />
										<label for="hrComments">Insurance Comments</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										<textarea name="gmComments" id="gmComments"></textarea>
										<label for="insComments">General Management Comments</label>
									</div>
								</div>
							</div>

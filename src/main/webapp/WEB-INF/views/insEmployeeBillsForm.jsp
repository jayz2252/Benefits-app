...
<body>
						...
						<div id="tabProviderInfo" class="col s12 tab_content">
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-6 padding_left_0">
										<label
											style="color: rgba(238, 110, 115, 0.7); margin-top: -21px;">Prescriber
											Details</label>
									</div>
								</div>
							</div>
								...
								<div class="md-form">
									...
									<div class="col-md-6 padding_left_0">
										<form:input path="prescriberContactNo"
											name="prescriberNameContact" id="prescriberContactNo"
							...
							<div id="specialistDetails">
								<div class="form-group is-empty">
									<div class="md-form">
										<div class="col-md-6 padding_left_0">
											<label
												style="color: rgba(238, 110, 115, 0.7); margin-top: -21px;">Specialist
												Details</label>
										</div>
									</div>
								</div>
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-6 padding_left_0">
										<label
											style="color: rgba(238, 110, 115, 0.7); margin-top: -12px;">PRO/Administrator
											Details</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group is-empty">
								<div class="md-form">
									<div class="col-md-12 padding_left_0">
										...
										<table class="responstable dynamicTable" id="billTable">
											<thead>
												<tr>
													<td></td>
													<td>Bill No</td>
															...
															<td>
																...
																<button type="submit"
																	...
																	<i class="fa fa-file-text"
																		style="color: #006699; font-size: 15px;"></i>
																</button>
															</td>
														</tr>
										...
										<button type="button" id="btnAddRow" class="btn blue darken-2">Add
											Row</button>
										<button type="button" id="billRemove" class="btn red darken-1"
											onclick="deleterow('billTable')">Remove Last Row</button>
									</div>
								</div>
							</div>
	...
	$('#prescriberName').on('change', function() {
	 ...
	 $('#other').on('change', function() {
		 ...
		 $('#amountRequired').on('change', function() {
			 document.querySelector('#amountRequired').classList.remove('alertAmount');
		...
		document.getElementById("bsub").type='submit';
		 if (confirm("Do you want to Submit the Bill?")) {
		    	...
		    	/* $(this).attr('href', '/home/myInsurancePlan/${planEmployeeId1}/newClaim/save'); */
     			...
     			$("#preAuthForm").attr("action","/home/myInsurancePlan/"+${planEmployeeId1}+"/newClaim/save");
...
/* 
		...
		$('#state').on('change', function() {
			...
			citySelect(state);
				 ...
				 function citySelect(state){
					 ...
					 var sel1 = document.getElementById('hospitalId');
						sel.innerHTML = "";
						sel1.innerHTML = "";
					    ...
					    sel1.innerHTML ="<option disabled selected>Choose Hospital</option>";
		...
		function setUrl(e,planEmployeeId) {
			...
			rowIndex = row.index(); 
		 $("#preAuthForm").attr("action","/home/myInsurancePlan/bills/new/billDetail/" + rowIndex);
...
var id = this.id.substr(0,this.id.length-1) + rowCount;
		...
		function deleterow(tableID) {
			...
			if(rowCount>2){
				...
				$.ajax({  
                    type : 'POST',  
                    url : "/home/myInsurancePlan/bills/new/billDetail/remove/" + (rowCount-1), 
                    dataType: 'json',
                });
